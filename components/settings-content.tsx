...
import { Bell, Globe, Lock, Palette, HardDrive, Trash2, Download, Shield, Server, Database } from "lucide-react"
          ...
          <Card className="bg-card border-border">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-lg bg-secondary">
                <div>
                  <p className="font-medium text-secondary-foreground">Authenticator App</p>
